...
require 'mailodds/models/batch_deliver_request'
require 'mailodds/models/batch_deliver_request_structured_data'
require 'mailodds/models/batch_deliver_response'
require 'mailodds/models/batch_deliver_response_delivery'
require 'mailodds/models/batch_deliver_response_rejected_inner'
require 'mailodds/models/check_suppression_request'
require 'mailodds/models/confirm_subscription200_response'
require 'mailodds/models/create_job_from_s3_request'
require 'mailodds/models/create_job_request'
require 'mailodds/models/create_list201_response'
require 'mailodds/models/create_list_request'
require 'mailodds/models/create_policy_from_preset_request'
require 'mailodds/models/create_policy_request'
require 'mailodds/models/create_sending_domain201_response'
require 'mailodds/models/create_sending_domain_request'
...
require 'mailodds/models/deliver_request'
require 'mailodds/models/deliver_request_options'
require 'mailodds/models/deliver_request_structured_data'
require 'mailodds/models/deliver_request_to_inner'
require 'mailodds/models/deliver_response'
require 'mailodds/models/deliver_response_delivery'
require 'mailodds/models/error_response'
require 'mailodds/models/get_lists200_response'
require 'mailodds/models/get_presigned_upload_request'
require 'mailodds/models/get_sending_domain_identity_score200_response'
require 'mailodds/models/get_sending_stats200_response'
require 'mailodds/models/get_sending_stats200_response_stats'
require 'mailodds/models/get_subscribers200_response'
...
require 'mailodds/models/list_sending_domains200_response'
...
require 'mailodds/models/sending_domain'
require 'mailodds/models/sending_domain_dns_records'
require 'mailodds/models/sending_domain_dns_records_ns'
require 'mailodds/models/sending_domain_identity_score'
require 'mailodds/models/sending_domain_identity_score_checks'
require 'mailodds/models/sending_domain_identity_score_checks_dkim'
require 'mailodds/models/sending_domain_identity_score_checks_dmarc'
require 'mailodds/models/subscribe_request'
require 'mailodds/models/subscriber'
require 'mailodds/models/subscriber_list'
...
require 'mailodds/models/unsubscribe_subscriber200_response'
require 'mailodds/models/update_policy_request'
require 'mailodds/models/validate_batch200_response'
require 'mailodds/models/validate_batch200_response_summary'
require 'mailodds/models/validate_batch_request'
require 'mailodds/models/validate_request'
require 'mailodds/models/validation_response'
require 'mailodds/models/validation_response_policy_applied'
...
require 'mailodds/api/email_sending_api'
require 'mailodds/api/email_validation_api'
require 'mailodds/api/sending_domains_api'
require 'mailodds/api/subscriber_lists_api'
