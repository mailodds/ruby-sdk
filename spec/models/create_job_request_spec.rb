...
# Unit tests for Mailodds::CreateJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Mailodds::CreateJobRequest do
  #let(:instance) { Mailodds::CreateJobRequest.new }

  describe 'test an instance of CreateJobRequest' do
    it 'should create an instance of CreateJobRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Mailodds::CreateJobRequest)
    end
  end
