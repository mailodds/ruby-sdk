...
# Unit tests for Mailodds::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Mailodds::Pagination do
  #let(:instance) { Mailodds::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Mailodds::Pagination)
    end
  end
