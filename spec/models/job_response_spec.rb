...
# Unit tests for Mailodds::JobResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Mailodds::JobResponse do
  #let(:instance) { Mailodds::JobResponse.new }

  describe 'test an instance of JobResponse' do
    it 'should create an instance of JobResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Mailodds::JobResponse)
    end
  end
